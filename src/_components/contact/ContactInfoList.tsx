    ...
    <div className="space-y-3 sm:space-y-4">
      {items.map((info) => (
        <a
          ...
          className={`cursor-pointer flex items-center gap-3 sm:gap-4 p-3 sm:p-4 ${cardHover} rounded-lg transition-all duration-300 group focus:outline-none focus:ring-4 focus:ring-white/30`}
        >
          ...
          <div className="flex-1">
            <p className={`text-xs sm:text-sm ${subtextColor} font-medium`}>
              {info.label}
            </p>
            <p
