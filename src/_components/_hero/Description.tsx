...
export function Description({ className = "", variants }: DescriptionProps) {
  return (
    <motion.p
      ...
      variants={variants}
    >
      Especializado em <strong>React</strong>, <strong>Next.js</strong>,{" "}
      <strong>Node.js</strong> e <strong>UX/UI Design</strong>. Apaixonado em
      criar interfaces intuitivas e responsivas e que fazem diferença na vida
      das pessoas.
    </motion.p>
  );
}
